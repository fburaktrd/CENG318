...
import EmptyFriend from "./EmptyFriend";
  ...
  export default function FriendList({username}) {
    ...
    return (
        <Fragment>
        {(isLoading ? <Banner message={"Recieving friend requests..."} />:empty ? <EmptyFriend/>:<div className="px-4 sm:px-6 lg:px-8">
        <div className="sm:flex sm:items-center">
          <div className="sm:flex-auto">
            <h1 className="text-xl font-semibold text-gray-900">Friend Requests</h1>
          ...
          <div className="-my-2 -mx-4 sm:-mx-6 lg:-mx-8">
            <div className="inline-block min-w-5 py-2 align-middle">
              <div className="shadow-sm ring-1 ring-black ring-opacity-5">
                <table className="min-w-5 border-separate" style={{ borderSpacing: 20 }}>
                      ...
                      <tr key={personIdx}>
                        <td
                          className={classNames(
                            personIdx !== requests.length - 1 ? 'border-b border-gray-200' : '',
            ...
            />
                        ...
                        >
                          <button className="flex items-center" onClick={()=>{SocialHandler.removeFriendRequest(username,person);
                        removePerson(personIdx);}}>
            <XIcon
